...
const Candidates = () => {
 ...
 // Statuses available for manual selection (excludes auto-managed statuses like new, reviewing, shortlisted)
 ...
 // Refresh both candidates and stats
 ...
 const handleStatusChange = async (candidateId, newStatus) => {
   try {
     ...
     // Refresh data to update stats immediately
     await refreshData();
   ...
   <EmployerLayout user={currentUser}>
     ...
     {stats && (
       <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
         <Card className={`border-none shadow-md transition-all duration-300 ${statsLoading ? 'opacity-50' : 'opacity-100'}`}>
