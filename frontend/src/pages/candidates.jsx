              ...
              <>
                ...
                <div className="mt-4 space-y-6">
                  ...
                  <div className="flex gap-2 pt-4 border-t">
                    ...
                    <Button className="flex-1 text-white hover: bg-gradient-to-r from-[#FF7A2D] to-[#FF9547] text-white/90">
          ...
          <DialogContent>
            ...
            <div className="mt-4 space-y-4">
              ...
              <div className="flex gap-2">
                ...
                <Button onClick={handleSaveNotes} className="flex-1 text-white hover: bg-gradient-to-r from-[#FF7A2D] to-[#FF9547] text-white/90">
                  Save Notes
                </Button>
              </div>
            </div>
